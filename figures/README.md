...
| `fig4_pointmass_ae.py` | Fig. 4 (`fig:f-point-mass`) | same for point-mass impulsive encounters with the full logLambda(a,e) (eqn:logLambda), logLambda_0 = 15; sub-thermal f_ss overlay + exact a0-slice L1 gate | ~4 min |
