...
-- sec:impulsive-coefficients): verify the drift and diffusion coefficients as
...
with open(tex_path, "w") as fh:
    fh.write("% Euler-angle-sector Fokker--Planck coefficients for impulsive\n"
             ...
             "% orbit average (eqn:orbit-average); tilde-r = 1 - e cos E = r/a.\n"
             ...
             "% and transform to the paper's body-frame results via eqn:change-of-basis-matrix.\n"
             "\\begin{align}\n")
